...
namespace StarterAssets {
    public partial class StarterAssetsDeployMenu : ScriptableObject {
        ...
        private static void ResetFirstPersonControllerCapsule() {
            ...
            // player
            if (player == null) {
                if (TryLocatePrefab(PlayerCapsulePrefabName, null, new[] { typeof(FirstPersonController) },
                        out var prefab, out var _))
        ...
        private static string GetFirstPersonPrefabPath() {
            if (TryLocatePrefab(PlayerCapsulePrefabName, null,
                    new[] { typeof(FirstPersonController), typeof(StarterAssetsInputs) }, out var _,
                    out var prefabPath)) {
