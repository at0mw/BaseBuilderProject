...
namespace BuildingSystem {
    public class GridBuildingSystem : MonoBehaviour {
        ...
        private void GhostBuild() {
            ...
            //_ghostObject.GetComponent<GhostBuilding>().ChangeToGhost();
        ...
        private GridObject AdjacentDirection(GridDirection closestEdge_, int x_, int z_, out GridDirection adjacentDirection) {
            adjacentDirection = closestEdge_.GetOpposite();
        ...
        public void SetBuildMode(bool currentState_) {
            Debug.Log($"Setting Build Mode {currentState_}");
            _destroyMode = false;
            _buildMode = currentState_;
        }
        
        public void SetDestroyMode(bool currentState_) {
            Debug.Log($"Setting Destroy Mode {currentState_}");
            _destroyMode = currentState_;
            _buildMode = false;
        }
    }
}